...
@section('dashboard-title', 'Edit Testimonial')
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0"><i class="bi bi-chat-quote me-2"></i>Edit Testimonial</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('super-admin.testimonials.update', $testimonial) }}" method="POST">
                        @csrf
                        @method('PUT')
