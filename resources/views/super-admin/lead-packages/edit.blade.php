...
@section('title', 'Edit Lead Package')
@section('dashboard-title', 'Super Admin - Edit Lead Package')

@section('content')
    <div class="card border-0 shadow-sm" style="max-width: 800px; margin: 0 auto;">
        <div class="card-body">
            <h2 class="mb-4 fw-bold">Edit Lead Package</h2>

            <form method="POST" action="{{ route('super-admin.lead-packages.update', $leadPackage) }}">
                @csrf
                @method('PUT')
