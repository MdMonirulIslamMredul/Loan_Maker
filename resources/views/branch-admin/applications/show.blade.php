...
@section('content')
    <div class="container-fluid py-4">
        <!-- Back Button -->
        <div class="mb-4">
            <a href="{{ auth()->user()->role === 'super-admin' ? route('super-admin.applications.index') : route('branch-admin.applications.index') }}"
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @else
                                    <strong
                                        class="text-muted">{{ Str::mask($application->email, '*', 1, strpos($application->email, '@') - 1) }}</strong>
                                @endif
                            </div>
                            <div class="col-md-6 mb-3">
                ...
                @if (!($user->isSuperAdmin() || $user->isBankAdmin() || $user->isBranchAdmin()) && !$hasAccess)
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body text-center">
                            <form action="{{ route('branch-admin.applications.unlock', $application) }}" method="POST">
                                @csrf
                                <button class="btn btn-primary">Unlock Lead (1)</button>
                            </form>
                            <p class="mt-2 text-muted small">Unlocking consumes 1 lead from your balance.</p>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <strong
                                    class="text-capitalize">{{ str_replace('-', ' ', $application->employment_type) }}</strong>
                            </div>
            ...
            <div class="col-lg-4">
                        ...
                        @if ($application->loan->branch->bank->bank_logo)
                            <div class="text-center mb-3">
                                <img src="{{ asset($application->loan->branch->bank->bank_logo) }}"
                                    alt="{{ $application->loan->branch->bank->bank_name }}" class="img-fluid"
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ auth()->user()->role === 'super-admin' ? route('super-admin.applications.updateStatus', $application) : route('branch-admin.applications.updateStatus', $application) }}"
                            method="POST">
                            @csrf
