    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ auth()->user()->role === 'super-admin' ? route('super-admin.applications.updateStatus', $application) : route('branch-admin.applications.updateStatus', $application) }}"
                          method="POST">
                        @csrf
