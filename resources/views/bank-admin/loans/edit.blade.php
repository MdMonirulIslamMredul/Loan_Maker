...
@section('dashboard-title', 'Bank Admin - Edit Loan')
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <div class="mb-4">
                ...
                <p class="text-muted">Update loan details for {{ Auth::user()->bank->name ?? 'your bank' }}</p>
            </div>
            ...
            <form action="{{ route('bank-admin.loans.update', $loan) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
